...
class discriminator(nn.Module):
	...
	def forward(self, x):
		...
		conv_out_2 = self.conv_layer2(conv_out_8)
		conv_out_3 = self.conv_layer3(conv_out_8)
		conv_out_4 = self.conv_layer4(conv_out_8)
		conv_out_5 = self.conv_layer5(conv_out_8)
		conv_out_6 = self.conv_layer6(conv_out_8)
		conv_out_7 = self.conv_layer7(conv_out_8)
		conv_out_8 = self.conv_layer8(conv_out_8)
